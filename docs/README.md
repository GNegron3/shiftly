...
```
docs/
├── company/          Company Manual — vision, mission, product requirements, data architecture
├── engineering/      Engineering Manual — standards, workflow, Definition of Done
...
- [Company Manual](company/Company_Manual.md)
- [Engineering Manual](engineering/Engineering_Manual.md)
