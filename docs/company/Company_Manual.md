...
Every shift creates conversations. Every table creates memories. Every bar seat has the potential to become a friendship. Guests return because of experiences, and experiences are created by people.
...
Technology should never replace hospitality. Technology should strengthen it.
...
We envision a hospitality industry where meaningful relationships no longer disappear simply because schedules change.

Our goal is not to build the largest hospitality application. Our goal is to become the most trusted platform for maintaining authentic relationships between hospitality professionals and the guests who choose to follow them.

Technology should quietly remove friction from human relationships rather than becoming the center of them.
...
Technology is our tool. Hospitality is our purpose. Every interaction should reflect warmth, professionalism, respect, and dependability.
...
Every startup faces pressure to move quickly. Speed matters, but direction matters more.
...
- Building deliberately instead of reactively
- Remaining focused on the mission that inspired the company

Every future leader should feel responsible for protecting these commitments.

---

### Operating Principles

**Think Long Term** — Choose decisions that will continue making sense years from now.

**Earn Trust Daily** — Trust is built through thousands of consistent actions.

**Solve Real Problems** — Every feature should solve a genuine problem experienced by users.

**Keep Things Simple** — Complexity should only exist when it creates meaningful value.
...
Before approving any feature or initiative, ask:
...
- Does it fit our documented architecture?
- Will hospitality professionals genuinely use it?

If these questions cannot be answered confidently, the proposal should be reconsidered.
...
Lower levels should never contradict higher levels. Engineering decisions should always support the company's vision rather than redefine it.
...
- Help professionals maintain guest relationships
- Make reconnecting simple for guests
- Protect user privacy
- Create value for professionals, guests, and hospitality venues
- Build a platform professionals use every week

---

### Target Users

**Primary:** Bartenders, servers, cocktail servers, private bartenders, and event bartenders.

**Secondary:** Guests who choose to follow professionals.

**Future:** Venue administrators and business partners.

---

### User Roles

**Professional:** Manage profile, schedule, followers, visibility, and future analytics.

**Guest:** View profiles, follow professionals, receive updates, and manage followed professionals.

**Admin (Future):** Moderation, support, and platform management.
...
- Payments and tipping for private events
- Analytics dashboard
...
**Relationship:** Repeat guest visits, follower retention, weekly schedule updates.

**Product:** Profile completion, active professionals, active guests, notification delivery.

**Business:** Sustainable growth, retention, and long-term trust.
...
- A replacement for hospitality venues
...
Every major feature should strengthen or support that relationship.
...
2. Profiles establish who a user is.
3. Schedules communicate availability.
4. Following creates permission-based relationships.
5. Notifications communicate schedule changes.
6. Analytics (future) measure engagement and growth.
...
1. Professional updates schedule.
2. Schedule is validated and saved.
3. Followers associated with that professional are identified.
4. Notifications are generated.
5. Guests receive updates.
6. Future analytics record engagement and guest check-ins.
...
Planned architectural additions include venue management, discoverability, reviews, private event workflows, payments, analytics, and business dashboards. Each addition should follow the same architectural standards documented in this manual.

---

## Chapter 4 — Product Principles & Guiding Decisions
...
**Relationships Come First** — Every feature should strengthen meaningful relationships between hospitality professionals and guests.
...
**Trust Over Growth** — Long-term trust always outweighs short-term growth opportunities.

**Real-World Experiences Matter** — The app exists to create more in-person hospitality experiences, not more screen time.

**Build Deliberately** — Every feature should solve a real problem and fit within the documented architecture.

**Future-Proof Decisions** — Prefer solutions that scale cleanly and minimize future rework.
...
- Design for future growth without overengineering the MVP
...
**Guest Profiles** — Stores guest-specific preferences and profile information. Responsibilities: display name, profile photo (optional), following preferences, notification preferences. Each guest has one profile.
...
- Professionals control discoverability
- Guests choose who they follow
- Relationships are permission-based
- Personal information is never exposed unnecessarily
- Only the minimum required data should be collected

---

### Future Data Entities (Post-MVP)

Reviews, Ratings, Private Event Requests, Payments, Venues, Saved Favorites, Guest Check-ins, Analytics, Achievements, Professional Verification, Business Accounts, Messaging (if justified).
